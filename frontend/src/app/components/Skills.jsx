...
//     <section
//       id="competences"
//       className={`relative py-40 w-full ${isDarkMode ? "bg-gradient-to-r from-gray-800 to-gray-900 text-white" : "bg-gradient-to-r from-blue-400 to-purple-400 text-black"}`}
//     >
...
//         {/* Titre */}
//         <h2 className="text-6xl font-extrabold mb-4 text-white uppercase tracking-wide drop-shadow-lg">
//           Compétences 🚀
//         </h2>
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-32 ">
//           {skills.map((skill, index) => (
//             <div
//               key={index}
//               className="flex flex-col items-center bg-white/100 shadow-box-red p-12 mb-12 ml-2 rounded-lg shadow-lg transition-transform duration-300 transform hover:scale-110 hover:rotate-3 hover:shadow-2xl ease-in-out" // Augmentez mb-12 et mr-12 pour plus d'espace
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full text-center"> 
        ...
        <h2 className={`text-6xl font-extrabold mb-4 text-white uppercase tracking-wide drop-shadow-lg transition-transform duration-700 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
          Compétences 🚀
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-32">
          {skills.map((skill, index) => (
...
//     { name: "React", icon: <FaReact size={50} className="text-cyan-500" />, description: "Bibliothèque populaire pour créer des interfaces." },
//     { name: "WordPress", icon: <FaWordpress size={50} className="text-indigo-500" />, description: "CMS pour créer des sites web." },
//     { name: "SEO", icon: <FaSearch size={50} className="text-orange-400" />, description: "Optimisation pour les moteurs de recherche." },
//     { name: "REST API", icon: <FaNodeJs size={50} className="text-green-600" />, description: "Création et utilisation de services RESTful." },
//     { name: "Node.js", icon: <FaNodeJs size={50} className="text-green-600" />, description: "Environnement JavaScript côté serveur." },
//     { name: "MongoDB", icon: <FaDatabase size={50} className="text-teal-500" />, description: "Base de données NoSQL pour les applications." },
//   ];
...
//       <div className="relative z-10 w-full text-center"> {/* Relative pour superposer le contenu sur la forme décorative */}
//         {/* Titre stylé avec une police expressive */}
//         <h2 className="text-6xl font-extrabold mb-10 text-white uppercase tracking-wide drop-shadow-lg">
//           Compétences 🚀
//         </h2>
...
//             <div
//               key={index}
//               className="flex flex-col items-center bg-white/80 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-transform duration-300 transform hover:scale-105"
//             >
//               <div className="text-blue-500 mb-4">
//                 {skill.icon}
//               </div>
