...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Détecter si la section "projets" est visible
  ...
  return (
    <>
      ...
      {/* Section Skills */}
      <section className={`relative w-full ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'}`}>
      ...
      {/* Divider */}
      <div id="apropos" className={`h-1 ${isDarkMode ? "bg-gray-600" : "bg-gray-300"}`}></div>
